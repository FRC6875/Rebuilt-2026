...
public class ShootCommand extends Command {
    ...
    private static final double TOP_MOTOR_VOLTAGE    = 8.0;  // Volts to run top motor
    private static final double BOTTOM_MOTOR_VOLTAGE = 8.0;  // Volts to run bottom motor
    private static final double TARGET_VELOCITY_RPS  = 96.416; // Target speed in rotations/sec
