...
public class VisionSubsystem extends SubsystemBase {
  ...
  public static class VisionConstants {
    ...
    public static final double [][] tagSpecificOffset = {
      {0, 0, 0, 0}};
   // Tag ID 0 -> figure out whats happening here
  ...
  private final PhotonCamera kAprilTagCam;
  
  //public final PhotonPoseEstimator aprilTagCam;

    //PhotonCamera camera = new PhotonCamera("AprilTag_Camera");
    PhotonPipelineResult result = aprilTagCam.getLatestResult(); //gets most recent data from photon vision
